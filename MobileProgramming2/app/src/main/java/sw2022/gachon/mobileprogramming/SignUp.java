...
public class SignUp extends AppCompatActivity {
    ...
    private EditText metName, metId, metPw; // 회원가입 입력필드
    int idCheck = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        duplicateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mDatabaseRef.child("UserAccount").child("IdList").child(metName.getText().toString()).child("idToken").addValueEventListener(new ValueEventListener() {
                    @Override
